...
const DoctorList = () => {
  const { changeAvailablity, doctorList} = useContext(AdminContext);

  return (
     <div className='flex flex-col text-red-800 px-4 sm:px-6 md:px-10 mt-5'>

      <p className='text-xl sm:text-2xl font-semibold text-start'> Doctor List </p>
          ...
          >
            ...
            <div className='p-3 bg-blue-50'>
              ...
              <div className="flex gap-2  items-center">
                <input type="checkbox" checked={iteam.available} onClick={()=>changeAvailablity(iteam._id)}/>
